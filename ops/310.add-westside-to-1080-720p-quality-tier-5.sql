-- @operation: export
-- @entity: batch
-- @name: Add WESTSiDE to 1080/720p Quality Tier 5
-- @exportedAt: 2026-08-26T23:23:08.418Z
-- @opIds: 13784, 13785, 13786, 13787, 13788, 13789, 13790

-- --- BEGIN op 13784 ( create regular_expression "WESTSiDE" )
insert into "regular_expressions" ("name", "pattern", "description", "regex101_id") values ('WESTSiDE', '(?<=^|[\s.-])0BSiDiAN\b', NULL, NULL);

insert into "tags" ("name") values ('Bluray') on conflict ("name") do nothing;

INSERT INTO regular_expression_tags (regular_expression_name, tag_name) VALUES ('WESTSiDE', 'Bluray');

insert into "tags" ("name") values ('Release Group') on conflict ("name") do nothing;

INSERT INTO regular_expression_tags (regular_expression_name, tag_name) VALUES ('WESTSiDE', 'Release Group');
-- --- END op 13784

-- --- BEGIN op 13785 ( update regular_expression "WESTSiDE" )
update "regular_expressions" set "pattern" = '(?<=^|[\s.-])WESTSiDE\b' where "name" = 'WESTSiDE' and "pattern" = '(?<=^|[\s.-])0BSiDiAN\b';
-- --- END op 13785

-- --- BEGIN op 13786 ( update custom_format "1080p Quality Tier 5" )
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required)
VALUES ('1080p Quality Tier 5', 'WESTSiDE', 'release_group', 'all', 0, 0);

INSERT INTO condition_patterns (custom_format_name, condition_name, regular_expression_name) VALUES ('1080p Quality Tier 5', 'WESTSiDE', 'WESTSiDE');
-- --- END op 13786

-- --- BEGIN op 13787 ( update custom_format "1080p Quality Tier 5 (Efficient)" )
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required)
VALUES ('1080p Quality Tier 5 (Efficient)', 'WESTSiDE', 'release_group', 'all', 0, 0);

INSERT INTO condition_patterns (custom_format_name, condition_name, regular_expression_name) VALUES ('1080p Quality Tier 5 (Efficient)', 'WESTSiDE', 'WESTSiDE');
-- --- END op 13787

-- --- BEGIN op 13788 ( update custom_format "720p Quality Tier 5" )
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required)
VALUES ('720p Quality Tier 5', 'WESTSiDE', 'release_group', 'all', 0, 0);

INSERT INTO condition_patterns (custom_format_name, condition_name, regular_expression_name) VALUES ('720p Quality Tier 5', 'WESTSiDE', 'WESTSiDE');
-- --- END op 13788

-- --- BEGIN op 13789 ( update regular_expression "UHD Bluray Release Groups" )
...
-- --- BEGIN op 13790 ( update regular_expression "UHD WEBRip Release Groups" )
