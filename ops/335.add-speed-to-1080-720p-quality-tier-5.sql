-- @operation: export
-- @entity: batch
-- @name: Add SPEED to 1080/720p Quality Tier 5
-- @exportedAt: 2026-09-01T21:59:31.015Z
-- @opIds: 14237, 14238, 14239, 14240, 14241, 14242, 14243

-- --- BEGIN op 14237 ( update regular_expression "UHD Bluray Release Groups" )
...
-- --- BEGIN op 14238 ( update regular_expression "UHD WEBRip Release Groups" )
...
-- --- BEGIN op 14239 ( create regular_expression "SPEED" )
insert into "regular_expressions" ("name", "pattern", "description", "regex101_id") values ('SPEED', '(?<=^|[\s.-])0BSiDiAN\b', NULL, NULL);

insert into "tags" ("name") values ('Bluray') on conflict ("name") do nothing;

INSERT INTO regular_expression_tags (regular_expression_name, tag_name) VALUES ('SPEED', 'Bluray');

insert into "tags" ("name") values ('Release Group') on conflict ("name") do nothing;

INSERT INTO regular_expression_tags (regular_expression_name, tag_name) VALUES ('SPEED', 'Release Group');
-- --- END op 14239

-- --- BEGIN op 14240 ( update regular_expression "SPEED" )
update "regular_expressions" set "pattern" = '(?<=^|[\s.-])SPEED\b' where "name" = 'SPEED' and "pattern" = '(?<=^|[\s.-])0BSiDiAN\b';
-- --- END op 14240

-- --- BEGIN op 14241 ( update custom_format "1080p Quality Tier 5" )
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required)
VALUES ('1080p Quality Tier 5', 'SPEED', 'release_group', 'all', 0, 0);

INSERT INTO condition_patterns (custom_format_name, condition_name, regular_expression_name) VALUES ('1080p Quality Tier 5', 'SPEED', 'SPEED');
-- --- END op 14241

-- --- BEGIN op 14242 ( update custom_format "1080p Quality Tier 5 (Efficient)" )
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required)
VALUES ('1080p Quality Tier 5 (Efficient)', 'SPEED', 'release_group', 'all', 0, 0);

INSERT INTO condition_patterns (custom_format_name, condition_name, regular_expression_name) VALUES ('1080p Quality Tier 5 (Efficient)', 'SPEED', 'SPEED');
-- --- END op 14242

-- --- BEGIN op 14243 ( update custom_format "720p Quality Tier 5" )
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required)
VALUES ('720p Quality Tier 5', 'SPEED', 'release_group', 'all', 0, 0);

INSERT INTO condition_patterns (custom_format_name, condition_name, regular_expression_name) VALUES ('720p Quality Tier 5', 'SPEED', 'SPEED');
-- --- END op 14243
